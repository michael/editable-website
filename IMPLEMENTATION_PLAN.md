...
- Edit URL opens the same dialog as the page browser ellipsis menu, and is disabled on the home page
- Duplicate page and Delete page stay presentational for now; wire them in a follow-up task
