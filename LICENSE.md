...
Permission is hereby granted to any person obtaining a copy of Editable and its documentation (the “Software”) to use, copy, and modify the Software locally, free of charge. A purchased license also permits its operation as one production website, subject to the following conditions.
...
**Do not bypass licensing.** Licensing notices and checks must not be removed, disabled, or circumvented.
