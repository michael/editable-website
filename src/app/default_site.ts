...
const FULL_DOC = {
    ...
    "nodes": {
        ...
        "JkfchFmwTqBYVZawgntPWxP": {
            ...
            "layout": "muted",
            "content": {
                "content": "On this demo page, changes are not persisted. On a real site, a logged in user would have their changes persisted to a database.",
                "marks": [],
                "annotations": []
            }
        },
        ...
        "enfBwMARyyTNCtvepmvUkXf": {
            ...
            "layout": "regular",
            "content": {
                "content": "To move blocks, drag from a dashed gap to select multiple, then cut and paste like usual.",
                "marks": [
                    {
                        "start_offset": 16,
                        "end_offset": 38,
        ...
        "vkfSmwrvhEvkmUjrwAcvgvA": {
            ...
            "layout": "muted",
            "content": {
                "content": "Tip: Press Esc one or more times to select parent blocks. Usually faster and more precise than dragging from a dashed gap.",
                "marks": [
                    {
                        "start_offset": 11,
                        "end_offset": 14,
        ...
        "HjCnaGHNswXGNmDReQhNPjy": {
            ...
            "layout": "regular",
            "content": {
                "content": "Open a folder on your computer that has some images. Select one and copy it to the clipboard. Select the placeholder below and paste it. To replace an image, select it first, then paste the new one on top.",
                "marks": [],
                "annotations": []
            }
        },
        ...
        "pFjJFVqzQzwUQzBhPQAqkuZ": {
            ...
            "layout": "regular",
            "content": {
                "content": "You can even paste several images at once. Select three or four from your computer and copy to the clipboard. Now select a vertical dashed area before or after an image above. Paste and all the images will be added in one go.",
                "marks": [
                    {
                        "start_offset": 123,
                        "end_offset": 143,
        ...
        "sBVXkwBDNWSvQvmDSUaQmSh": {
            ...
            "layout": "regular",
            "content": {
                "content": "When you add images in the text flow, like the one above, you'll be able to change its size using the handles at the edges of the image.",
                "marks": [
                    {
                        "start_offset": 102,
                        "end_offset": 122,
        ...
        "askXYZSpXVmkUURQpjBUCEd": {
            ...
            "layout": "regular",
            "content": {
                "content": "You can even paste short video clips onto any media placeholder. Currently .mp4 , .webm, and of course .gif are supported.",
                "marks": [
                    {
                        "start_offset": 75,
                        "end_offset": 79,
        ...
        "KUAHxAZZcZTtjmHHBfbrbfs": {
            ...
            "layout": "regular",
            "content": {
                "content": "The cards above are links to examples of live in-place editable websites Johannes Mutter and I have already launched using this technology. You can see that any design is possible — it’s just HTML and CSS.",
                "marks": [
                    {
                        "start_offset": 73,
                        "end_offset": 88,
        ...
        "fMgsDXKARPqeRZGCmYKuvqj": {
            ...
            "layout": "regular",
            "content": {
                "content": "Editable is powered by Svelte and Svedit — an open source rich text editor I’ve created. It builds on SvelteKit and SQLite to enable full websites with multiple pages and a persistent backend where only an admin can make changes.",
                "marks": [
                    {
                        "start_offset": 102,
                        "end_offset": 111,
        ...
        "HgJRTPUBDfGQFhEDmwcNQNW": {
            ...
            "layout": "regular",
            "content": {
                "content": "The source code is not only available for Editable, but for all the foundations it is built on:",
                "marks": [],
                "annotations": []
            }
        },
        ...
        "PgFkSEuFXmXvecwFNksBFfw": {
            ...
            "layout": "regular",
            "content": {
                "content": "The editing infrastructure (Svedit) becomes an integral part of your website (at runtime). As a developer, all you do is define content types (e.g. Figure) and implement components (e.g. Figure.svelte) — they are editable by default.",
                "marks": [
                    {
                        "start_offset": 187,
                        "end_offset": 200,
        ...
        "fWGAzktgaAYgCnbjDDNZqZt": {
            ...
            "layout": "regular",
            "content": {
                "content": "There is experimental support for mobile editing — it works in principle. The current focus is on desktop UX, but mobile editing will improve over time.",
                "marks": [],
                "annotations": []
            }
        },
        ...
        "wdKfHzXjUysbpyHBKWnjHPp": {
            ...
            "layout": "regular",
            "content": {
                "content": "All content lives in a single data directory — an SQLite database (db.sqlite3) and uploaded assets (data/assets). Locally this defaults to ./data. On Fly.io it's a persistent volume at /data. To back up your site, copy this directory.",
                "marks": [
                    {
                        "start_offset": 30,
                        "end_offset": 34,
        ...
        "ahabwjAyHuBbTNMJacqWupQ": {
            ...
            "layout": "regular",
            "content": {
                "content": "Editable is a foundational, AI-agnostic tool. That said, it makes perfect sense to utilize AI workflows to help building your custom site. Think prompts like \"Create a paragraph block type with layout variants\" and \"Implement Paragraph.svelte with 2 layouts\".",
                "marks": [],
                "annotations": []
            }
        },
        ...
        "vuEMUDFAUnxSBXvsvDsYDZe": {
            ...
            "layout": "regular",
            "content": {
                "content": "Editable is modular and you can and should reuse code across projects. However, I purposely don't want to establish a community maintained plugin repository. I want to encourage you to own all your code, for the benefit of simplicity, safety, and control. Share code snippets, not plugins.",
                "marks": [],
                "annotations": []
            }
        },
        ...
        "ZdwnbaVUbAPYzCZQhyJAYBr": {
            ...
            "layout": "regular",
            "content": {
                "content": "Editable runs on any VPS. All you need is Node.js and SQLite. The repository includes a Dockerfile and fly.toml for one-command deployment to Fly.io. The same Dockerfile works with any platform that supports Docker.",
                "marks": [
                    {
                        "start_offset": 103,
                        "end_offset": 111,
        ...
        "prwbeXWyKVSsJXMPndjHYRS": {
            ...
            "layout": "regular",
            "content": {
                "content": "There's no point for static builds with Editable. The whole idea is that users edit content live, without having to wait for a rebuild to finish. SQLite is fast. Very fast. Web-optimized images are generated client-side before upload: resizing happens in the browser via canvas and toBlob(), and WebP encoding is done with @jsquash/webp. It still makes sense to enable a proxy for images, so they can be delivered from a CDN.",
                "marks": [
                    {
                        "start_offset": 323,
                        "end_offset": 336,
        ...
        "VmvAPSsWYbVnekGqYyEKPUG": {
            ...
            "layout": "regular",
            "content": {
                "content": "Editable is source-available software. You can download it, run it locally, and modify it without restrictions. If you publicly launch a website backed by Editable, we ask you for a one-time registration fee for each launched domain.",
                "marks": [],
                "annotations": []
            }
        },
        ...
        "vWuEJXfcsUSSXwYKQmbAnxq": {
            ...
            "layout": "regular",
            "content": {
                "content": "Since 2011 I’ve been taming web browsers to behave correctly and predictably when editing rich text.",
                "marks": [
                    {
                        "start_offset": 21,
                        "end_offset": 40,
        ...
        "HTXqugHBTYdFtsEPuJBwdcQ": {
            ...
            "layout": "regular",
            "content": {
                "content": "I want you to be able to launch websites that anyone can edit. No more calls asking you to update someone’s WordPress site! They’ll be able to do it themselves.",
                "marks": [],
                "annotations": []
            }
        },
        "QEnRdGNnZesaJWpDstgKQhq": {
            ...
            "layout": "regular",
            "content": {
                "content": "Most CMSs are too complex for clients and too restrictive for developers. Change every pixel of your site, create new content types, or integrate 3rd party data. Everything you can do with Svelte, you can do with Editable.",
                "marks": [],
                "annotations": []
            }
        },
        ...
        "vvqbUaMzgjJXvJGMzHFDnrE": {
            ...
            "layout": "muted",
            "content": {
                "content": "Big thanks to Johannes Mutter for helping with concept, design, and engineering, Tom Atkins for support with positioning and copywriting, and Sonja Stojanovic for being the very first happy Editable user — followed by Trails, Postlmayr Design, Aufreiter Architektur, and many more.",
                "marks": [
                    {
                        "start_offset": 14,
                        "end_offset": 29,
        ...
        "KHTAxQcgeFDzUgxvcpHURuy": {
            ...
            "type": "footer_link",
            "href": "/product#why-editable",
            "target": "_self",
            "label": {
                "content": "Why Editable?",
                "marks": [],
                "annotations": []
            }
        },
        ...
        "XwSHBshPgtBVkfKwwZpmGXz": {
            ...
            "type": "footer_link",
            "href": "https://github.com/michael/editable/discussions",
            "target": "_self",
            "label": {
                "content": "Discussions",
                "marks": [],
        ...
        "DCjbSqkDXcnzARnaVVfZgvD": {
            ...
            "type": "footer_link",
            "href": "https://github.com/michael/editable",
            "target": "_self",
            "label": {
                "content": "GitHub",
                "marks": [],
        ...
        "page_1": {
            ...
            "type": "page",
            "title": {
                "content": "Editable — the website you can edit on the page",
                "marks": [],
                "annotations": []
            },
            "description": {
                "content": "Editable lets you build and edit a Svelte website without adding a separate CMS. Editors work directly on the page, while the content model, components, layouts, and styling remain in the codebase you own.",
                "marks": [],
                "annotations": []
            },
