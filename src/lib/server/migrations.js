...
const nav_1 = {
	...
	nodes: {
		...
		FKgjxHCeSbVZrdnPuxYkMYp: {
			...
			target: '_blank',
			label: { text: 'Join the Technical Preview', annotations: [] }
		}
	}
};
...
const footer_1 = {
	...
	nodes: {
		footer_1: {
			...
			type: 'footer',
			logo: 'footer_logo',
			copyright: { text: '© Editable Website', annotations: [] },
		...
		fcSSWQUTYajjknPChgGsPZz: {
			...
			label: { text: 'On this page', annotations: [] },
			footer_links: [
		...
		EtcfbabRCtPSvSpfFfjPeza: {
			...
			href: '/#RtYpQwXsZvNmKjHgFdSaLe',
			target: '_self',
			label: { text: 'Editing', annotations: [] }
		},
		WVvBSREFCThNYcpgvfUnWkF: {
		...
		GwPeRFYtAyrcCMfpuyzdWZp: {
			...
			target: '_self',
			label: { text: 'Links', annotations: [] }
		},
		footer_column_2: {
			id: 'footer_column_2',
			type: 'footer_link_column',
			label: { text: 'GitHub', annotations: [] },
		...
		uavzfSnSpTRrHSfJpbfvpsh: {
			...
			target: '_blank',
			label: { text: 'Editable Website', annotations: [] }
		},
		footer_link_2_1: {
			id: 'footer_link_2_1',
			type: 'footer_link',
			...
			target: '_blank',
			label: { text: 'Svedit', annotations: [] }
		},
		footer_column_3: {
			id: 'footer_column_3',
			type: 'footer_link_column',
			label: { text: 'Videos', annotations: [] },
		...
		ewuBYPxRqFsJXffTuwqssXg: {
			...
			target: '_blank',
			label: { text: 'Introduction', annotations: [] }
		},
		cCMbgzNjRjVjrvWuHJCvJkx: {
			...
			target: '_blank',
			label: { text: 'Update 2025-10', annotations: [] }
		}
	}
};
...
const page_1 = {
	...
	nodes: {
		...
		hero_1: {
			...
			description: { text: 'Dream no more…', annotations: [] },
		...
		uqZnrCRbzCkBWmYNQYkFePY: {
			...
			type: 'text',
			layout: 5,
			content: { text: 'Editing', annotations: [] }
		},
		WsXcDfVgBhNjMkLqAzPeRt: {
			id: 'WsXcDfVgBhNjMkLqAzPeRt',
			type: 'text',
			layout: 2,
			content: { text: 'This is Editable Website', annotations: [] }
		},
		...
		ywTQktXzgyRqzsUNXjZztQw: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 6, end_offset: 18, node_id: 'RezNUsxYmfpmFMezpgEbqYu' }
				]
			}
		},
		NhhsYbqTRzPtpQcHFUgwFhP: { id: 'NhhsYbqTRzPtpQcHFUgwFhP', type: 'strong' },
		ypAZzWFdhamCaTMKmZMZPMm: { id: 'ypAZzWFdhamCaTMKmZMZPMm', type: 'strong' },
		wuyFjXptXyMvgYKUcvtTggC: { id: 'wuyFjXptXyMvgYKUcvtTggC', type: 'strong' },
		ZWDXzUmKJbqDwJbNTbhEtWQ: { id: 'ZWDXzUmKJbqDwJbNTbhEtWQ', type: 'strong' },
		zqyQQtSbzxtdTTsVTYuuXEh: { id: 'zqyQQtSbzxtdTTsVTYuuXEh', type: 'strong' },
		CUTpvupqUbXQDyMjBczwfCj: { id: 'CUTpvupqUbXQDyMjBczwfCj', type: 'emphasis' },
		PYHXbxRMREHBpAqxbdsUXzP: { id: 'PYHXbxRMREHBpAqxbdsUXzP', type: 'strong' },
		djTpcsEQTzfGMSRctKenpWt: { id: 'djTpcsEQTzfGMSRctKenpWt', type: 'emphasis' },
		...
		WjasMkTrmjdrXTsDgeUHQap: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 29, end_offset: 41, node_id: 'NhhsYbqTRzPtpQcHFUgwFhP' },
					{ start_offset: 43, end_offset: 45, node_id: 'ypAZzWFdhamCaTMKmZMZPMm' },
					{ start_offset: 49, end_offset: 50, node_id: 'wuyFjXptXyMvgYKUcvtTggC' },
					{ start_offset: 61, end_offset: 73, node_id: 'ZWDXzUmKJbqDwJbNTbhEtWQ' },
					{ start_offset: 92, end_offset: 104, node_id: 'zqyQQtSbzxtdTTsVTYuuXEh' },
					{ start_offset: 105, end_offset: 238, node_id: 'CUTpvupqUbXQDyMjBczwfCj' },
					{ start_offset: 0, end_offset: 4, node_id: 'PYHXbxRMREHBpAqxbdsUXzP' },
					{ start_offset: 6, end_offset: 13, node_id: 'djTpcsEQTzfGMSRctKenpWt' },
					{ start_offset: 18, end_offset: 23, node_id: 'eUteADFhxtenJraxpeprgHr' }
				]
			}
		},
		...
		HWcSGEAsZyfeQFjgvKrMpZc: {
			...
			type: 'text',
			layout: 5,
			content: { text: 'Blocks', annotations: [] }
		},
		heading_1: {
			id: 'heading_1',
			type: 'text',
			layout: 2,
			content: { text: 'Build with blocks', annotations: [] }
		},
		pRPkWyTzrgwfHhbnUgvHPph: { id: 'pRPkWyTzrgwfHhbnUgvHPph', type: 'strong' },
		fuxtxNCceDRcdbcHhtqsYwJ: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 17, end_offset: 36, node_id: 'pRPkWyTzrgwfHhbnUgvHPph' }
				]
			}
		},
		szexETNtKsPwJPPECvSbMbn: { id: 'szexETNtKsPwJPPECvSbMbn', type: 'strong' },
		uDAGgETYUPFDYHKSvDBwmPw: { id: 'uDAGgETYUPFDYHKSvDBwmPw', type: 'strong' },
		MheDsAwTmfQDGqdkpMWgXUH: { id: 'MheDsAwTmfQDGqdkpMWgXUH', type: 'strong' },
		dAEBKADbvfeaBMhNWgTjKNC: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 155, end_offset: 175, node_id: 'szexETNtKsPwJPPECvSbMbn' },
					{ start_offset: 83, end_offset: 88, node_id: 'uDAGgETYUPFDYHKSvDBwmPw' },
					{ start_offset: 11, end_offset: 22, node_id: 'MheDsAwTmfQDGqdkpMWgXUH' }
				]
			}
		},
		GZGpvNSHNjPJtHVfmGbRBNf: { id: 'GZGpvNSHNjPJtHVfmGbRBNf', type: 'strong' },
		TfUCWjmVMpUWSNWhBkBjTgB: { id: 'TfUCWjmVMpUWSNWhBkBjTgB', type: 'strong' },
		ryUPAdHaGfFcHAqdHPSdUMR: { id: 'ryUPAdHaGfFcHAqdHPSdUMR', type: 'strong' },
		wrMTxwEDPezkagDwymXFFuq: { id: 'wrMTxwEDPezkagDwymXFFuq', type: 'strong' },
		dKDJFxDKresxkjMUZYKNuKn: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 81, end_offset: 86, node_id: 'GZGpvNSHNjPJtHVfmGbRBNf' },
					{ start_offset: 120, end_offset: 139, node_id: 'TfUCWjmVMpUWSNWhBkBjTgB' },
					{ start_offset: 18, end_offset: 41, node_id: 'ryUPAdHaGfFcHAqdHPSdUMR' },
					{ start_offset: 174, end_offset: 194, node_id: 'wrMTxwEDPezkagDwymXFFuq' }
				]
			}
		},
		fwXyaDrZNGRyMhZMbascTYb: { id: 'fwXyaDrZNGRyMhZMbascTYb', type: 'strong' },
		dwMqDGUwHVvVkdzahPEWDuR: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 16, end_offset: 35, node_id: 'fwXyaDrZNGRyMhZMbascTYb' }
				]
			}
		},
		FGHDfRZMdeYQeVJBarNFeHa: { id: 'FGHDfRZMdeYQeVJBarNFeHa', type: 'strong' },
		gkHzcWkcKRsYffDnwJtGnjG: { id: 'gkHzcWkcKRsYffDnwJtGnjG', type: 'strong' },
		smJYScwGbZgRVDAJWhNGxvG: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 0, end_offset: 8, node_id: 'FGHDfRZMdeYQeVJBarNFeHa' },
					{ start_offset: 15, end_offset: 18, node_id: 'gkHzcWkcKRsYffDnwJtGnjG' }
				]
			}
		},
		xKmNqPrStVwYzAbCdEfGh: {
		...
		AHXsSZcYYwnXKYzHbDnSRRh: {
			...
			type: 'text',
			layout: 5,
			content: { text: 'Images', annotations: [] }
		},
		BfpsPAaqmJXnRrHzwJCSMHE: {
			id: 'BfpsPAaqmJXnRrHzwJCSMHE',
			type: 'text',
			layout: 2,
			content: { text: 'Add images to a gallery', annotations: [] }
		},
		...
		NKtUpjrVYCGaJWYKGACXprb: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 123, end_offset: 143, node_id: 'cMtzexVuqMWFgEpxhYjRQFq' },
					{ start_offset: 13, end_offset: 33, node_id: 'BKVAhVQRTzRGhGGqpfrQnsu' }
				]
			}
		},
		BPdekRaDEUcQZqtEwPwBvyu: {
			...
			layout: 1,
			colorset: 0,
			intro: ['AHXsSZcYYwnXKYzHbDnSRRh', 'BfpsPAaqmJXnRrHzwJCSMHE', 'DpajqNKpCCFFqZHtbttRRwM'],
			gallery_items: [
				'wtvHDBrCzJVgacTaJqAwNJk',
				'TQRANBXMrzXXZTtzxAYhhZf',
				'HtSTZfjTcDSkttVaTUKMYAj'
			],
			outro: ['NKtUpjrVYCGaJWYKGACXprb']
		},
		...
		FMmrrRxdfRzhujVmergnVxA: {
			...
			type: 'text',
			layout: 5,
			content: { text: 'Links', annotations: [] }
		},
		AjbSGnXVcWpHBurCTrKxYSs: {
			id: 'AjbSGnXVcWpHBurCTrKxYSs',
			type: 'text',
			layout: 2,
			content: { text: 'Link to other pages', annotations: [] }
		},
		XDMsYPfWXKqvhCMsEDWfDnx: { id: 'XDMsYPfWXKqvhCMsEDWfDnx', type: 'strong' },
		VdjTDrdPmtXRuYKNUMeRmKK: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 93, end_offset: 105, node_id: 'XDMsYPfWXKqvhCMsEDWfDnx' }
				]
			}
		},
		...
		kZQHRTYyJtbmsJfnXaRgVtZ: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 73, end_offset: 88, node_id: 'VqaqUWzRKUJrZzQYqqurggB' }
				]
			}
		},
		jLnPqRsTuVwXyZaBcDeFg: {
			...
			outro: ['kZQHRTYyJtbmsJfnXaRgVtZ']
		},

		// Prose — how does this work
		pkcwHuntQjySVjwuVNaSTge: {
			id: 'pkcwHuntQjySVjwuVNaSTge',
			type: 'text',
			layout: 5,
			content: { text: 'Built for developers, designed for everyone', annotations: [] }
		},
		AQHAsyghanqZPmyutAJZBxM: {
			id: 'AQHAsyghanqZPmyutAJZBxM',
			type: 'text',
			layout: 2,
			content: { text: 'How does this work?', annotations: [] }
		},
		...
		PscvEBWBfhraXpPKjPPkCMC: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 117, end_offset: 126, node_id: 'vgwPcMefbMumuCsVyAPHhUz' },
					{ start_offset: 131, end_offset: 137, node_id: 'qHveqveRzQxJzxGakaarEwb' },
					{ start_offset: 24, end_offset: 30, node_id: 'sheNSfrhuAfrBWSKfvWPYGg' },
					{ start_offset: 35, end_offset: 41, node_id: 'NZHwrDvtUBdpyDMvRJEGPcc' }
				]
			}
		},
		...
		EsVdYMdJuVqGfqpQmMBCtap: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 19, end_offset: 30, node_id: 'hpXfpDueZmgNjRfMUBREPnh' }
				]
			}
		},
		XVJGXtwnQMvcrcuByAtcWNa: {
		...
		pCjecUjAFDGgGpgquwGrCdp: {
			...
			type: 'text',
			layout: 2,
			content: { text: "Hello, I'm Michael", annotations: [] }
		},
		...
		qDAyeabdhVEXjBWXyyqfUPb: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 21, end_offset: 40, node_id: 'gnbpgBsBYZqEwRxqRZSMHdd' }
				]
			}
		},
		...
		UBNYngEBJYtDWgeabtDJqWW: {
			...
			layout: 3,
			colorset: 0,
			title: { text: 'I love it! How can I get it?', annotations: [] },
			description: {
		...
		PjwvEAbrZCxZFcqJqayVyhR: {
			...
			content: {
				...
				annotations: [
					{ start_offset: 14, end_offset: 29, node_id: 'ERqkusuryvGKBzKayXyhxXE' },
					{ start_offset: 81, end_offset: 91, node_id: 'XCdmKqAtyRNPKKRZJaNUfyX' },
					{ start_offset: 142, end_offset: 158, node_id: 'yjdxqchTwgSjeTVgXeZhrrv' },
					{ start_offset: 240, end_offset: 246, node_id: 'TPsjXxZhtuyfJQRytAVcRgJ' },
					{ start_offset: 248, end_offset: 264, node_id: 'SUfVhRdtQwruDYJvgkETZxk' },
					{ start_offset: 266, end_offset: 287, node_id: 'amXvCtNxBsTJFzfeTCpdMsN' }
				]
			}
		},
		wmrbpSFAFUmMRPDumcjKqpF: {
