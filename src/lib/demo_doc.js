...
export const PAGE_1 = {
	...
	nodes: {
		...
		jLnPqRsTuVwXyZaBcDeFg: {
			...
			layout: 1,
			colorset: 0,
			intro: ['FMmrrRxdfRzhujVmergnVxA', 'AjbSGnXVcWpHBurCTrKxYSs', 'VdjTDrdPmtXRuYKNUMeRmKK'],
		...
		swiper_slide_1: {
			id: 'swiper_slide_1',
			type: 'swiper_slide',
			media: 'swiper_slide_1_image'
		},
		swiper_slide_2_image: {
		...
		swiper_slide_2: {
			id: 'swiper_slide_2',
			type: 'swiper_slide',
			media: 'swiper_slide_2_image'
		},
		swiper_slide_3_image: {
		...
		swiper_slide_3: {
			id: 'swiper_slide_3',
			type: 'swiper_slide',
			media: 'swiper_slide_3_image'
		},
		demo_swiper: {
			id: 'demo_swiper',
			type: 'swiper',
			layout: 1,
			slides: ['swiper_slide_1', 'swiper_slide_2', 'swiper_slide_3']
		},
		page_1: {
			id: 'page_1',
			type: 'page',
