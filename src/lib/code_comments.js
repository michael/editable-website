 ...
 *
 * @param {string} text
 * @returns {{ text: string, comment: boolean }[] | null}
 */
export function split_code_comments(text) {
	...
	/** @type {{ text: string, comment: boolean }[]} */
	const segments = [];
	let normal_start = 0;
 ...
 * @returns {boolean}
 */
function looks_like_shell(text) {
