...
{#snippet layout_1()}
	<div class="{TW_LIMITER}">
		<div class="border-(--border-color) border-r border-l {TW_BLOCK_PADDING_Y}">
...
{#snippet layout_2()}
	<div class="{TW_LIMITER}">
		<div class="border-(--border-color) xl:border-r xl:border-l {TW_BLOCK_PADDING_Y}">
...
<Node class="ew-prose lg:text-lg xl:text-xl layout-{layout} border-b border-(--border-color) bg-(--background) text-(--foreground) {colorset_class}" {path}>
