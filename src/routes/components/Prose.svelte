...
{#snippet layout_1()}
	<div class="{TW_LIMITER}">
		<div class="xl:border-r xl:border-l {TW_BLOCK_PADDING_Y}">
...
{#snippet layout_3()}
	<div class="{TW_LIMITER}">
		<div class="xl:border-r xl:border-l grid grid-cols-3 {TW_BLOCK_PADDING_Y}">
...
<Node class="ew-prose lg:text-lg layout-{layout} border-t" {path}>
