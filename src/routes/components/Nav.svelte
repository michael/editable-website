...
<Node {path}>
	<div class="{TW_LIMITER}">
		<div class="flex items-stretch border-l border-r border-(--foreground-subtle) lg:text-lg">
			<!-- Logo -->
			...
			<NodeArrayProperty class="nav-items hidden md:flex items-stretch space-x-2 sm:space-x-4 py-4 {TW_PAGE_PADDING_X}" path={[...path, 'nav_items']} />
