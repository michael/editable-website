		...
		<div class="min-h-screen flex items-center py-20 md:py-28 lg:py-36">
			<div class="{TW_PAGE_PADDING_X} mx-auto max-w-5xl text-center w-full" use:reveal>
				<AnnotatedTextProperty
					tag="h1"
					class="ew-h1 leading-tight text-5xl md:text-6xl lg:text-7xl text-balance text-(--foreground)"
					path={[...path, 'title']}
					placeholder="Your bold statement goes here"
				/>
				<AnnotatedTextProperty
					tag="p"
					class="mt-6 md:mt-8 text-lg md:text-xl text-balance text-(--foreground)/50"
