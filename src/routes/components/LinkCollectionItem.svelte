...
<Node class="link-collection-item h-full" {path}>
	...
	>
		...
		<div class="p-5 md:p-6">
			<AnnotatedTextProperty class="font-medium text-sm uppercase tracking-wider text-(--foreground-accent) mb-2" path={[...path, 'preline']} placeholder="Preline" />
			<AnnotatedTextProperty class="font-heading text-(--foreground-accent) text-xl md:text-2xl lg:text-3xl text-balance pt-1" path={[...path, 'title']} placeholder="Title" />
