...
<Node class="nav-image flex items-center shrink-0 min-w-10" {path}>
	<svelte:element
		class="h-6 block min-w-0 outline-1 outline-transparent focus-visible:outline-1 focus-visible:outline-(--svedit-editing-stroke) focus-visible:outline-offset-1"
